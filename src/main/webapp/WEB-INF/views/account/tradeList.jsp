...
$(function(){   
    ...
    columns:[[    
        {field:'id',title:'流水号'},    
        {field:'type',title:'操作类型',sortable:true,width:100}, 
        {field:'fromCard',title:'账号',sortable:true,width:160,formatter: function(value,row,index){
